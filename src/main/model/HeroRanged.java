...
//represents a hero of type ranged
public class HeroRanged extends Hero {

    private static final int increaseHpAmount = 8;
    private static int increaseAttackAmount = 7;
    private static int increaseExperienceRequiredAmount = 20;

    public HeroRanged(String heroName, String heroClass) {
